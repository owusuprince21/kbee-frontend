...
export const metadata = {
  title: "Return & Exchange Policy | KBee Computers",
  description:
    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-50">
      ...
      <section className="border-b bg-gradient-to-br from-yellow-50 via-white to-white">
        <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:py-14">
          <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-yellow-200 bg-yellow-50 px-3 py-1 text-xs font-semibold text-yellow-700">
      ...
      <section className="mx-auto w-full max-w-5xl px-4 py-8 sm:py-12">
        ...
        >
          {[
            ...
            <a
              ...
              href={`#${href}`}
              className="
                rounded-lg border bg-white px-3 py-2 text-center font-medium
        ...
        <div className="prose prose-slate max-w-none prose-a:text-yellow-600 prose-headings:scroll-mt-24">
          {/* 1. Quick Overview */}
            ...
            <div className="not-prose overflow-hidden rounded-xl border bg-white">
              <div className="overflow-x-auto">
                <table className="min-w-full text-left text-sm">
                  <thead className="bg-yellow-50 text-slate-700">
                    <tr>
          ...
          <section id="process" className="scroll-mt-28">
            ...
            <ol>
              <li>
                ...
                <Link href="/support/rma" className="text-yellow-600 hover:underline">
                  /support/rma
                </Link>{" "}
                if available.)
              </li>
          ...
          <section id="contact" className="scroll-mt-28">
            ...
            <ul>
              ...
              <li>
                <strong>Phone/WhatsApp:</strong> +233 ••• •• •••
              </li>
              <li>
        ...
        {/* Callout card */}
        <div className="mt-10 rounded-2xl border bg-white p-5 shadow-sm sm:p-6">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              <h3 className="text-base font-semibold text-slate-900">Start a return</h3>
            ...
            <div className="flex gap-3">
              <a
                href="mailto:hello@kbeecomputers.com?subject=RMA%20Request"
                className="rounded-lg border px-4 py-2 text-sm font-medium text-yellow-700 hover:bg-yellow-50"
              >
